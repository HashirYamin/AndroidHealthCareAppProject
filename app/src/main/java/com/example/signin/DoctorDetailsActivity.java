...
public class DoctorDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            it1.putExtra("text2", filteredList.get(i).get("line1"));
            it1.putExtra("text3", filteredList.get(i).get("line2"));
            it1.putExtra("text4", filteredList.get(i).get("line3"));
            it1.putExtra("text5", filteredList.get(i).get("line4"));
            it1.putExtra("text6", doctor_details[i][4]);
            startActivity(it1);
        });
